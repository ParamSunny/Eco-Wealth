          ...
          <div class="row justify-content-center">
            <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 order-lg-2 offset-xl-1 mb-4">
              <div class="img-wrap text-center text-md-left" data-aos="fade-up" data-aos-delay="100">
                <div class="img">
                  <img src="img_v_3.jpg" alt="circle image" class="img-fluid">
                </div>
              </div>
            </div>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5">
            <div class="images-overlap">
              <img src="img_v_1.jpg" alt="student" class="img-fluid img-1" data-aos="fade-up">
            </div>
          </div>
          ...
          <div class="swiper init-swiper" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="team">
                  <div class="pic">
                    <img src="team-1.jpg" alt="Image" class="img-fluid">
                  </div>
                  <h3 clas="">
              ...
              <div class="swiper-slide">
                <div class="team">
                  <div class="pic">
                    <img src="team-2.jpg" alt="Image" class="img-fluid">
                  </div>
                  <h3 clas="">
              ...
              <div class="swiper-slide">
                <div class="team">
                  <div class="pic">
                    <img src="team-3.jpg" alt="Image" class="img-fluid">
                  </div>
                  <h3 clas="">
              ...
              <div class="swiper-slide">
                <div class="team">
                  <div class="pic">
                    <img src="team-4.jpg" alt="Image" class="img-fluid">
                  </div>
                  <h3 clas="">
            ...
            <div class="swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="testimonials-1.jpg" alt="Image" class="img-fluid">
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="testimonials-2.jpg" alt="Image" class="img-fluid">
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="testimonials-3.jpg" alt="Image" class="img-fluid">
                    </figure>
