...
<link rel="stylesheet" href="https://unpkg.com/bs-brain@2.0.4/components/registrations/registration-9/registration-9.css">
                ...
                <div class="row gy-3 overflow-hidden">
                    <div class="col-12">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="comName" id="email" placeholder="name@example.com" required>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <p class="m-0 text-secondary text-center">Don't have an account? <a href="Com-register.php" class="link-success text-decoration-none">Sign in</a></p>
                  </div>
                </div>
              </div>
              <div class="row">
