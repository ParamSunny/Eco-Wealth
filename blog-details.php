          ...
          <section id="blog-comments" class="blog-comments section">
            ...
            <div class="container">
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="comments-1.jpg" alt=""></div>
                  <div>
              ...
              <div id="comment-2" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="comments-2.jpg" alt=""></div>
                  <div>
                ...
                <div id="comment-reply-1" class="comment comment-reply">
                  <div class="d-flex">
                    <div class="comment-img"><img src="comments-3.jpg" alt=""></div>
                    <div>
                  ...
                  <div id="comment-reply-2" class="comment comment-reply">
                    <div class="d-flex">
                      <div class="comment-img"><img src="comments-4.jpg" alt=""></div>
                      <div>
              ...
              <div id="comment-3" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="comments-5.jpg" alt=""></div>
                  <div>
              ...
              <div id="comment-4" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="comments-6.jpg" alt=""></div>
                  <div>
...
<script>
const url = 'https://yahoo-finance160.p.rapidapi.com/getlogo';
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'f5f1ce20dfmsh44fe0a828fef462p18d997jsnfc507c2c581d',
