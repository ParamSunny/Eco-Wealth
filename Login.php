  ...
  <header id="head" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
            <li><a class="nav-link scrollto" href="Card-purchase.php">Card</a></li>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <p class="m-0 text-secondary text-center">Don't have an account? <a href="Register.php" class="link-success text-decoration-none">Sign in</a></p>
                  </div>
                </div>
              </div>
              <div class="row">
